...
class Lcategory
{
    ...
    //Category product
    public function category_product($cat_id, $links, $per_page, $page, $price_range = null, $size = null, $subcat = null, $rate = null, $sort = null)
    {
//dd($rate);
        $CI =& get_instance();
        ...
        $max_value = 0;
        $min_value = 0;
        $category_product = $CI->Categories->category_product($cat_id, $per_page, $page, $price_range, $size, $subcat, $rate,$sort);
...
//dd($variant_list);
        ...
        $data = array(
            ...
            'cat_image' => $category[0]['cat_image'],
