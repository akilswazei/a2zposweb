                 ...
                 <div class="col-md-12">
                       <div class="customcard">
                        ...
                        <form action="" method="post" class="update_user">
                           ...
                           <!-- cardbody -->
                           <input type="hidden" name="cashier_id" id="user_id" value="<?= isset($user['cashier_id']) ? $user['cashier_id'] : '' ;?>"class="form-control">

                           <div class="customcardfooter">
                              <div style="text-align: center;">
                                  <a href="<?=base_url('Ccashieruser/manage_cashier')?>" class="btn btn-outline-dark btn-sm customfootercancelbtn">Cancel</a>
  ...
  $(document).ready(function() {
      ...
      $('#btnSave').click(function(){
            ...
            $.ajax({
                type: 'ajax',
                method: 'post',
                url: '<?=base_url("Ccashieruser/update_cashier");?>',
                ...
                success: function(data){
                 console.log(data);
                  ...
                  setTimeout( function (){
                    ...
                    window.location = '<?=base_url("Ccashieruser/manage_cashier")?>';
                  },1600);
                },
