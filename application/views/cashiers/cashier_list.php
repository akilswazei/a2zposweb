              ...
              <div class="customcard">
                <div >
                  <div class="usercardheader">
                        ...
                        <a href="<?=base_url('Ccashieruser')?>" type="button" class="btn btn-outline-dark alluserbtn adduserbtn">Add
                       ...
                       <tbody>
                         ...
                         <tr>
                           ...
                           <td> <?php if($u['status']== 1) { ?>
                                 <span class="badge greenbadge">Active</span>
                                <?php }else{ ?>
                                <span class="badge redbadge">Inactive</span>
                                <?php } ?>
                           </td>
                           <td><?=$u['email']?></td>
                           <td style="text-align: center;">
                               <a  href="<?=base_url('Ccashieruser/cashier_view?id='.$u['cashier_id'])?>" type="button" class="btn btn-outline-dark alluserbtn">View
                               ...
                               <a href="<?=base_url('Ccashieruser/cashier_update_form?id='.$u['cashier_id'])?>" type="button" class="btn btn-outline-dark alluserbtn">Edit
                               ...
                               <button type="button" class="btn btn-outline-dark alluserbtn deleteRecord" data-id="<?php echo $u['cashier_id'];?>" data-toggle="modal" data-target="#deleteModal">Delete
  ...
  <script type="text/javascript">
    ...
    // // delete emp record
        $('#btnDelete').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url('Ccashieruser/cashier_delete')?>",
                dataType: "JSON",
                data: {
                    id: userId
                },
