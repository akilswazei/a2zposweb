...
<nav id="sidebar">
  <div class="sidebar-header">
    ...
    <!-- <img style="width: 170px;" src="<?= base_url('assets/') ?>images/Liquor-011.png">         -->
      <h3>  <?php   echo $getsitelogo['logo'] ?> </h3>
  ...
  <div class="side-nav">
    <ul class="categories">
      ...
      <li>
        ...
        <a class="childarrow <?php echo in_array($segment, ['merchant','Cstore','Cterminal'])?'opend':'' ?>"  href="#">
          <svg width="14" height="17" viewBox="0 0 11 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10.2 9.40445L7.5 7.40445C8.4 6.70445 9 5.70445 9 4.50445V3.70445C9 1.80445 7.6 0.104445 5.7 0.00444541C3.7 -0.0955546 2 1.50445 2 3.50445V4.50445C2 5.70445 2.6 6.70445 3.5 7.40445L0.8 9.50445C0.3 9.90444 0 10.5044 0 11.1044V13.0044C0 13.6044 0.4 14.0044 1 14.0044H10C10.6 14.0044 11 13.6044 11 13.0044V11.0044C11 10.4044 10.7 9.80445 10.2 9.40445Z" />
          </svg><span>Merchant Management</span>
        </a>
        <ul class="side-nav-dropdown" style="<?php echo in_array($segment, ['merchant','Cstore','Cterminal'])?'display: block':'' ?>">
          <li><a class="<?php echo in_array($segment, ['merchant'])?'active':'' ?>" href="<?php echo base_url('merchant') ?>">Merchant</a></li>
          <li><a class="<?php echo in_array($segment, ['Cstore'])?'active':'' ?>" href="<?php echo base_url('Cstore') ?>">Store</a></li>
          <li><a class="<?php echo in_array($segment, ['Cterminal'])?'active':'' ?>" href="<?php echo base_url('Cterminal/manage_store_terminal') ?>">Terminal</a></li>
  ...
  <div class="menu-header">
    ...
    <div style="float: right;position: relative;top: 4px;">
            ...
            'password' => 'swazeiCentral@123',
              ...
              $stores=$db2->where(['merchant_id' => $this->session->userdata('merchant_id')])->get('store_set')->result();
            ...
            <?php   foreach ($stores as $key => $value) { ?>
              <option value="<?php echo base_url() ?>/adminlogin/switch_to_store?username=<?php echo $value->store_email ?>&user_db_session=<?php echo $value->store_db ?>&merchant_id=<?php echo $this->session->userdata('merchant_id') ?>"><?php   echo $value->store_name ?></option>
            <?php   } ?>
                <option value="<?php echo base_url() ?>/Admin_dashboard/do_merchant_switch">Back to merchant</option>
              </option>
            </select>
