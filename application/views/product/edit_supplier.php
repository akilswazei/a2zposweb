               ...
               <div class="row">
                 <div class="col-md-12">
                       <div class="customcard">
                        ...
                        <form action="" method="post" class="edit_supplier" autocomplete="off"> 
                           <!-- cardheader -->
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control customcardinput" id="fname" name="supplier_name" aria-describedby="" value="<?= isset($supplier['supplier_name']) ? $supplier['supplier_name'] : '' ;?>"  onkeypress="return onlyAlphabets(event,this);" readonly>
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                          <label class="customcardlabel">Contact Number *</label>
                                           <input type="tel" class="form-control customcardinput phoneInput" id="mobile" name="mobile" aria-describedby="" value="<?= isset($supplier['mobile']) ? $supplier['mobile'] : '' ;?>"  placeholder="Enter Contact Number" maxlength="14" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" >
                                     ...
                                     <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control customcardinput" id="email" name="email" aria-describedby="" value="<?= isset($supplier['email']) ? $supplier['email'] : '' ;?>" placeholder="Enter Email" onkeyup="ValidateEmail();" >
                                     ...
                                     <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control customcardinput" id="address" name="address" aria-describedby="" value="<?= isset($supplier['address']) ? $supplier['address'] : '' ;?>" placeholder="Enter Supplier Address">
                                    ...
                                    <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control customcardinput" name="details" aria-describedby="" value="<?= isset($supplier['details']) ? $supplier['details'] : '' ;?>" placeholder="Enter Supplier Details">
    ...
    <option value="<?=$c['category_id']?>" <?php if(in_array($c['category_id'],explode(',',$supplier['supplier_category']))){echo 'selected';}?>>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control customcardinput" id="cname" name="contact_name" aria-describedby="" placeholder="Enter Supplier Contact Person Name" value="<?= isset($supplier['contact_name']) ? $supplier['contact_name'] : '' ;?>" onkeypress="return onlyAlphabets(event,this);">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control customcardinput" id="cemail" name="contact_email" aria-describedby="" value="<?= isset($supplier['contact_email']) ? $supplier['contact_email'] : '' ;?>" placeholder="Enter Supplier Contact Person Email" onkeyup="ValidateCEmail();">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control customcardinput phoneInput" id="cmobile" name="contact_no" aria-describedby="" value="<?= isset($supplier['contact_no']) ? $supplier['contact_no'] : '' ;?>"  placeholder="Enter Supplier Contact Person Contact No" maxlength="14" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
      ...
      $('#btnSave').click(function(){
          ...
          if($('#cmobile').val().length != 14 ){
            ...
            $.ajax({
                type: 'ajax',
                method: 'post',
                url: '<?=base_url("Cproduct/update_supplier")?>',
