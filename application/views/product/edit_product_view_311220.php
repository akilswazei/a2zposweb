             ...
             <div class="row">
               <div class="col-md-12">
                     ...
                     <div class="customcard">
                         ...
                         <!-- cardheader -->
                        <form action="<?=base_url('Cproduct/update_product')?>" method="post" class="edit-product" enctype="multipart/form-data" autocomplete="off"> 
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="product_name" name="product_name" aria-describedby="" value="<?=$productdata['product_name']?>">
                                  ...
                                  <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="product_nickname" name="product_nickname" aria-describedby="" placeholder="enter Product NickName" value="<?=$productdata['short_name']?>">
                                  ...
                                  <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="unit" name="unit" aria-describedby="" placeholder="enter Product Unit" value="<?=$productdata['unit']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="sku" name="sku" aria-describedby="" placeholder="enter SKU" value="<?=$productdata['SKU']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="size" name="size" aria-describedby="" placeholder="enter Product Size" value="<?=$productdata['size']?>">
                                        ...
                                        <label class="customcardlabel" for="">Brand</label>
                                         ...
                                         <select  name="brand_id" style="width: 100%" class="form-control customcardinput mySelect for" id="brand">
                                                ...
                                                <?php foreach($brand as $b) { ?>
                                                  <option value="<?=$b['brand_id']?>" <?php echo ($productdata['brand_id'] ==  $b['brand_id']) ? ' selected="selected"' : '';?>>
                                                    <?=$b['brand_name']?></option>
                                                <?php } ?>  
                                              </select>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select  name="category_id" style="width: 100%" class="form-control customcardinput mySelect for" id="category">
                                       ...
                                       <?php foreach ($category as $c) {?>
                                                  <option value="<?=$c['category_id']?>" <?php echo ($productdata['category_id'] ==  $c['category_id']) ? ' selected="selected"' : '';?>>
                                                    <?=$c['category_name']?></option>
                                                    <?php if(!empty($c['sub_cat'])){
                                                      foreach($c['sub_cat'] as $sub_ct1){ ?>
                                                        <option value="<?=$sub_ct1['category_id']?>" <?php echo ($productdata['category_id'] ==  $sub_ct1['category_id']) ? ' selected="selected"' : '';?>>
                                                          <?=$c['category_name']?> > <?=$sub_ct1['category_name']?> 
                                                        </option>
                                                        <?php if(!empty($sub_ct1['child_cat'])){ 
                                                          foreach($sub_ct1['child_cat'] as $sub_ct2){ ?>
                                                            <option value="<?=$sub_ct2['category_id']?>" <?php echo ($productdata['category_id'] ==  $sub_ct2['category_id']) ? ' selected="selected"' : '';?>>
                                                              <?=$c['category_name']?> > <?=$sub_ct1['category_name']?> >
                                                              <?=$sub_ct2['category_name']?>
                                                            </option>
                                                          <?php if(!empty($sub_ct2['grand_cat'])){ 
                                                            foreach($sub_ct2['grand_cat'] as $grnd_ct){ ?>
                                                          <option value="<?=$grnd_ct['category_id']?>" <?php echo ($productdata['category_id'] ==  $grnd_ct['category_id']) ? ' selected="selected"' : '';?>>
                                                            <?=$c['category_name']?> > <?=$sub_ct1['category_name']?> >
                                  ...
                                  <div class="col-md-6 mb-4">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="producer" aria-describedby="" name="producer" placeholder="Please enter the Producer" value="<?=$productdata['producer']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="tilte" aria-describedby="" name="Meta_Title" placeholder="Please enter Meta Title" value="<?=$productdata['Meta_title']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="Meta_Key" aria-describedby="" name="Meta_Key" placeholder="Please enter the Product Tag" value="<?=$productdata['Meta_key']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control customcardinput" id="Description" aria-describedby="" name="Meta_Desc" placeholder="Please enter Meta Description" value="<?=$productdata['Meta_Desc']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="abv" aria-describedby="" name="abv" placeholder="Please enter the ABV" <?=$productdata['abv']?>>
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" id="proof" aria-describedby="" name="proof" placeholder="Please enter Proof" value="<?=$productdata['proof']?>">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-group">
                                        <label class="customcardlabel">Geography</label>
                                                     <input type="text" class="form-control customcardinput" id="region" aria-describedby="" name="region" placeholder="Please enter Geography " value="<?=$productdata['region']?>">
                                      </div>
                                   </div>
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label class="customcardlabel">Supplier Price*</label>
                                                    <input type="tel" class="form-control customcardinput" id="supplier_price" aria-describedby="" name="supplier_price" placeholder="Please enter Supplier Price" value="<?=$productdata['supplier_price']?>">
                                    ...
                                    <div class="col-md-6 mb-4">
                                                   <div class="form-group">
                                                     ...
                                                     <input type="text" class="form-control customcardinput" id="store_sell_price" aria-describedby="" name="store_sell_price" placeholder="Please enter Store Sell Price " value="<?=$productdata['price']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                      <label class="customcardlabel" for="">Upload Image</label>
                                       <?php
                                        if($productdata['image_large_details']!= '')
                                        {
                                          ?>
                                            <img src="<?=base_url().$productdata['image_large_details']?>" width="60" height="40" align="right">
                                       <?php
                                        }
                                          ?>                                        
                                        <input type="file" class="form-control customcardinput" id="product_img" name="photo" aria-describedby="" value="<?=$productdata['image_large_details']?>">
                                   ...
                                   <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="2" ><?=$productdata['product_details']?></textarea>
                                      </div>
                         ...
                         <div class="customcardfooter">
                            <div style="text-align: center;">
                                ...
                                <button type="submit" class="btn btn-primary customcardfooteraddbtn btn-sm">Update</button>
                            </div>
                         </div>
                         </form>
                     </div>
