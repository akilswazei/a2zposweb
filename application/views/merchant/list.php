            ...
            <div class="customcard">
                <div>
                    <div class="usercardheader">
                        <p>All Merchants</p>
                        <a href="<?=base_url('merchant/add')?>" type="button" class="btn btn-outline-dark alluserbtn adduserbtn">
                            Add Merchant
                        ...
                        <table class="table table-striped text-center" id="dataTableExample2">
                            ...
                            <tbody> 
                            	<?php foreach ($merchants as $key => $value) { ?>
                                  ...
                                  <td>
                                    <a href="<?php echo base_url('Cterminal/manage_store_terminal?merchant_id='.$value->id) ?>">
                                    <?php echo $this->merchant->count_terminals($value->merchant_id); ?>
                                      </a>
                                    </td>
                                  <td>
                                    <a href="<?php echo base_url('Cstore?merchant_id='.$value->id) ?>">
                                    <?php echo $this->store->count_store_by_merchant_id($value->merchant_id); ?></td>
                                    </a>  
                            			<td><?php echo $value->address ?></td>
                            			<td>
                                       <a href="<?php echo base_url('superadmin/merchant/edit/'.$value->merchant_id) ?>" class="btn btn-outline-dark alluserbtn">Edit
                                      ...
                                      <button type="button" class="btn btn-outline-dark alluserbtn deleteRecord" data-id="<?php echo $value->merchant_id ?>" data-toggle="modal" data-target="#deleteModal">Delete
