                        ...
                        <div class="customcard">
                            <div>
                                <div class="usercardheader">
                                    <p>All Discounts</p>
                                    <a href="<?=base_url('Ccoupon/add_discount')?>" type="button" class="btn btn-outline-dark alluserbtn adduserbtn">Add  Discounts                                            
                                    <svg class="discount" width="22" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
