             ...
             <div class="row">
               <div class="col-md-12">
                     <div class="customcard">
                         ...
                         <!-- cardheader -->
                         <form action="<?=base_url('LoyaltyPoint/insert_point')?>" method="post" class="add_coupon" autocomplete="off"> 
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-12">
                                     <div class="form-group">
                                        ...
                                        <select class="form-control customcardinput" required="" name="point_type" id="point_type">
                                   ...
                                   <div class="col-md-6 point">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" name="point" id="point" value="" onkeypress="return isNumberKey(this, event);"/>
                                   ...
                                   <div class="col-md-6 pamount">
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customcardinput" name="point_amount" id="point_amount" value="" onkeypress="return isNumberKey(this, event);"/>
