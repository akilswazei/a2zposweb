             ...
             <div class="row">
               <div class="col-md-12">
                     <div class="customcard">
                         ...
                         <!-- cardheader -->
                         <form action="<?=base_url('Loyalty/insert_promotion')?>" method="post" class="add_promotion" autocomplete="off"> 
                               ...
                               <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name ="promotion_name" class="form-control customcardinput" id="promotion_name" aria-describedby="" placeholder="Enter Promotion Name">
                                   ...
                                   <div class="col-md-6 comboAMT">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <input type="tel" class="form-control customcardinput" name="combo_amount" id="combo_amount" onkeypress="return isNumberKey(this, event);" />
                                             </div>
                                   ...
                                   <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 coupDetails">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control inputfile customcardinput" name="promotion_details" id="details" placeholder="Enter Promotion Details" />
