          ...
          <div class="row">
            <div class="col-md-2">
              <?php if (isset($_GET['customerid'])) { ?>
                <p>Update customer</p>
              <?php } else { ?>
                <p class="text-nowrap">Add new customer</p>
              <?php } ?>
            </div>
            <div class="col-md-10">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control customcardinput" id="country" name="country">
                        ...
                        <?php
                        if (isset($customerdata['country']) == false)
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control customcardinput" id="discount" name="discount" aria-describedby="" placeholder="Please enter discount">
...
<script type="text/javascript">
  ...
  $('#discount').on('keypress', function() {
    ...
    var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
    if (!regex.test(key)) {
      $("#discount_err").html("Only numbers allowed").show();
      return false;
    } else {
      $("#discount_err").html("").show();
