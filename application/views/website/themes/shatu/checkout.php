...
<?php if ($this->cart->contents()) { ?>
    <form action="<?php echo base_url('submit_checkout') ?>" id="validateForm" method="post" class="checkout-conent">
		<div class="checkout_address_step">
			<div class="container">
				<div class="checkout-page">
					...
					<div class="checkout-inner">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group has-error">
										...
										<input type="hidden" name="ac_pass" id="ac_pass" value="123456" />
									</div>
									<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-primary radius-1 show_second_step">Place Order</button>
						</div>
					</div>
					</div>
				</div>
		...
		<div class="checkout_payment_step" style="display:none;">
			<div class="container">
            <div class="checkout-page">
            <h1><?php echo display('payment_details') ?></h1>
            <div class="checkout-inner">
                
                <div class="check-out-right" >
                    <div class="check-orde">
                        <div class="payment_top">
                        <h4><?php echo display('total_payment');  ?></h4>
						...
						<span class="final_amount"><?php
						$total_tax = $cgst + $sgst + $igst;
						echo(($position == 0) ? $currency . " " . number_format($cart_total, 2, '.', ',') : number_format($cart_total, 2, '.', ',') . " " . $currency) ?></span>
...
<script type="text/javascript">
	$(".show_second_step").on('click',function(){
		if($("#validateForm").valid()){
			$(".checkout_address_step").hide();
			$(".checkout_payment_step").show();
		}
	})
    //Retrive district
