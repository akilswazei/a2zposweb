        ...
        <div class="row">
            <div class="col-md-12 p-0">
                <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-rep bg-dark py-3 px-4">
                    ...
                    </button> <a class="navbar-brand" href="javascript:;" onclick="javascript: history.back(-1);">Price Override</a>
                        ...
                        <table class="table table-sm cell-border" id="tbl_inventory" style="width:100%">
                            <thead class="headsec">
                                <tr>
                                    ...
                                    <th class="text-white">Override Price</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php print $value_tsi["first_name"]." ".$value_tsi["last_name"]; ?></td>
                                    <td><?php print $value_tsi["order_id"]; ?></td>
                                    <td><?php print $value_tsi["base_price"]; ?></td>
                                    <td><?php print $value_tsi["override_price"]; ?></td>
                                    <td><?php print date("m/d/Y", strtotime($value_tsi["created_at"])); ?></td>                                    
                                </tr>
                                <?php
                                        }
                                    }
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on("click","#frmDetailsFilterBtn",function() {
            ...
            window.open('<?php print base_url(); ?>cashier/kpi_price_override_detail/'+product_name+'/'+start_date_filter+'/'+end_date_filter, '_self').focus();
        });
            ...
            buttons: [
                {
                    ...
                    text: 'Email',
                    action: function () {
                        extendDataTable(tbl_inventory,"Price Override");
                    }
                }
            ],
        });
