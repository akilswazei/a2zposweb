...
<body class="body2" onload="window.print();window.close();">
  ...
  <div class="table-con">
              ...
              <td>
                  <div class="p-wrapper">
                    <p class='product m-0'><span class="bold"></span>(-)$<?php
                                            ...
                                            $pp = $price;
                                            $sub_total=$sub_total+$pp;
                                            $container_deposit_total=$container_deposit_total+$value['container_deposit'];
    ...
    <div class="total-con d-flex justify-content-between">
      ...
      <?php
      $grand_total = $sub_total+$getPOSReceiptData['tax']+$container_deposit_total;
      ?>
      <div class="right-col d-flex flex-column text-right">
        <p>(-)$<?php print number_format($sub_total, 2); ?></p>
        <p>(-)$<?php print $getPOSReceiptData['tax']; ?></p>
        <p>(-)$<?php print $container_deposit_total; ?></p>
