<div class="container content dynamic_font_size" id='recon-report'>
    <div class="row reconciliation_report_ajax">
        ...
        <div class="col-md-12 p-0">
            <div class="container table-responsive pt-1 header-fix-recon">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="bg-green">
                                <?php
                                    if($key_rr == "cash_proceeds" || $key_rr == "card_proceeds" || $key_rr == "ebt_card_proceeds" || $key_rr == "cash_sales")
                            ...
                            <td>
                                <div class="closed">
                                    <?php
                                    if($value_dt != "-" && $key_rr != "Status" && $key_rr != "Updated" && $value_rr["label"] != "Status" && $value_rr["label"] != "Updated") {
                                        print "$".$value_dt;
                                    } else {
                                        print $value_dt;
                                    }
