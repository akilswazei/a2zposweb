        ...
        <div class="row">
            <div class="col-md-12 p-0">
                <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-rep bg-dark py-3 px-4">
                    ...
                    </button> <a class="navbar-brand" href="javascript:;" onclick="javascript: history.back(-1);"><?php print $heading; ?></a>
                ...
                <div class="col-md-12">
                    <div class="">
                        ...
                        <table class="table table-sm cell-border" id="tbl_inventory" style="width:100%">
                            <thead class="headsec">
                                <tr>                                    
                                    <th class="text-white" width="80%" style="text-align:left !important;">Username</th>                                    
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>                                    
                                    <td style="text-align:left !important;"><?php print $value_tsi["first_name"]." ".$value_tsi["last_name"]; ?></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on("click","#frmDetailsFilterBtn",function() {
            ...
            window.open('<?php print base_url(); ?>cashier/kpi_detail_void_no_sale/'+<?php print $event_type; ?>+'/'+start_date_filter+'/'+end_date_filter, '_self').focus();
        });
