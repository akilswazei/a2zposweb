        ...
        <div class="row">
            <div class="col-md-12 p-0">
                <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-rep bg-dark py-3 px-4">
                    ...
                    </button> <span class="navbar-brand">Daily Category Type BreakDown</span>
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <div class="d-flex justify-content-end btninbig">
                        <button class="bckbtn btn-backWrapper newredwrap reportbackbtn" onclick="goBack('sales-report');" >
            ...
            <div class="row px-12">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="start_date_filter" id="start_date_filter" class="form-control" value="<?php if(!empty($start_date_filter)) print $start_date_filter; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>End Date</label>
                        <input type="date" name="end_date_filter" id="end_date_filter" class="form-control" value="<?php if(!empty($end_date_filter)) print $end_date_filter; ?>">
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on("click","#frmDetailsFilterBtn",function() {
            ...
            window.open('<?php print base_url(); ?>cashier/cbdreports/'+category_id_encoded+'/'+start_date_filter+'/'+end_date_filter, '_self').focus();
        });
