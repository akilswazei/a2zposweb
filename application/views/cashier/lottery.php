            ...
            <div class="col-md-12">
                <div class="customcard pt-2">
                    ...
                    <div>
                        <div class="">
                            <div class="">
                                <table class="table table-sm cell-border" id="tbl_lottery" style="width:100%">
                                    <thead class="headsec">
                                        <tr>
...
<!--                                            <th class="text-white">Winning Amount</th>-->
                                            <th class="text-white">Quantity</th>
                                             <th class="text-white">Lottery Number</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
          //  alert("dasd"); exit;
            var oTable = $('#tbl_lottery').dataTable({
               "processing": true,
                "serverSide": true,
                "pageLength": 10,
                "autoWidth": true,
                ...
                "ajax": "<?php echo base_url() . 'cashier/Cashier/lotterydatalist'; ?>",

            });

            jQuery(document).on("focus", "#read_barcode", function(e) {
                $('#tbl_lottery_filter input').val('');
                oTable.fnFilter('');
            });
...
//                                    $('#employee_id').val(data.products[0].employee_id);
                                    ...
                                    $('#lottery_name').val(data.products[0].lottery_name);
...
//                            }
                            $("#read_barcode").val('');
                            $('#tbl_lottery_filter input').focus();
