            ...
            <div class="col-md-12">
                <div class="customcard">
                    <div class="customcardheader1">
                        <div class="row">
                            <p>Update Scratcher</p>
                        </div>
                    </div>

                    <form action="" method="post" class="edit-scratcher" autocomplete="off">
                        <!-- cardheader -->
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" id="scratcher_id" name="scratcher_id" value="<?= isset($scratcher['id']) ? $scratcher['id'] : '' ;?>">
                                            <label class="customcardlabel" for="">Game Name *</label>
                                            <input type="text" class="form-control customcardinput" id="game_name" name="game_name" aria-describedby="" placeholder="Enter Game Name" value="<?= isset($scratcher['game_name']) ? $scratcher['game_name'] : '' ;?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" onkeyup="this.value = get_float_value(this.value)" onClick="this.select();" class="form-control customcardinput" id="price_per_ticket" aria-describedby="" name="price"  placeholder=" Enter Price" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="<?= isset($scratcher['price']) ? $scratcher['price'] : '' ;?>"></div>
<!--                                            <input type="text" class="form-control customcardinput " id="price_per_ticket" name="price_per_ticket" aria-describedby="" placeholder="Enter Ticket Price" maxlength="14" >-->
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <input type="tel"  onClick="this.select();" class="form-control customcardinput" id="upc" aria-describedby="" value="<?= isset($scratcher['upc']) ? $scratcher['upc'] : '' ;?>" name="upc"  placeholder=" Enter UPC" ></div>
                                           <span class="errors" id="upc_err" style="color:red; font-size:14px"></span>
                                        </div>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="customcardlabel">Bin *</label>
                                    <input type="tel"  onClick="this.select();" class="form-control customcardinput" id="bin_data" aria-describedby="" name="bin_data" value="<?= isset($scratcher['bin_data']) ? $scratcher['bin_data'] : '' ;?>" placeholder=" Enter Bin" ></div>
                                     <span class="errors" id="bin_err" style="color:red; font-size:14px"></span>
                                     </div>
                                    <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="customcardlabel">Expiry *</label>
                                    <input type="date"  onClick="this.select();" class="form-control customcardinput" id="expiry" aria-describedby="" value="<?= isset($scratcher['expiry']) ? $scratcher['expiry'] : '' ;?>" name="expiry"  placeholder=" Enter Expiry" ></div>
                                    ...
                                    <div style="position:relative;" ><span class="prefix">$</span>
                                    <input type="tel" onkeyup="this.value = get_float_value(this.value)" onClick="this.select();" value="<?= isset($scratcher['payout_prize']) ? $scratcher['payout_prize'] : '' ;?>" class="form-control customcardinput" id="payout_prize" aria-describedby="" name="payout_prize"  placeholder="   Winning Amount" oninput="  this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');"></div>
    ...
    <script type="text/javascript">
         $('#btnSave').on('click', function() {
             ...
             var formdata = $('.edit-scratcher')[0];
//      $.ajax({
//          url: "<?=base_url('cashier/Cashier/updatescratcher')?>",
//          type:"post",
...
//              swal({
//                title: "Success!",
//                text: "Scratcher is Successfully Updated",,
//                icon: "success",
//                buttons: false,
//              });
//            }else{
