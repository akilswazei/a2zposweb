	...
	<style>
		...
		#print_receipt_view_id p {
			margin-bottom: 0.5em;
		}

		#print_receipt_view_id table {
			width: 100%;
		}

		#print_receipt_view_id thead>th:nth-child(1) {
			text-align: left;
		}

		#print_receipt_view_id th:last-child {
			text-align: right;
		}

		#print_receipt_view_id tr>td {
			text-align: left !important;
			height: 30px;
		}

		#print_receipt_view_id tr>td:last-child {
		...
		#print_receipt_view_id table th {
		    background: #FFFFFF;
		    color: black;
		    padding: 0 0;
	...
	<div id="print_receipt_view_id">
		<a href="#close-modal" rel="modal:close" class="modal_print_data_close"> <img src="http://localhost/lunavo/pos030122/a2zpos-web/assets/images/x-square.svg" alt="" class="x"></a>
