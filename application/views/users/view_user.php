    <div class="container-fluid mt20">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="customcrambli"><a href="<?=base_url('User/manage_user')?>">All Users</a></p>
                <span class="customscrambspan">></span>
                <p class="customcrambli2">Admin</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="shadowcard">
                                    ...
                                    <div class="pad10">
                                        <div class="row">
                                            <div class="col-md-5 mb-2">
                                                <p class="shadowcardlabel">Role : <span>
                                                  <?php foreach($front_role as $userrole){
                                                      if($userrole['id']==$userdata['role']) {
                                                        echo $userrole['role_name'];
                                                      }
                                                  } ?>
                                                </span></p>
                                                <p class="shadowcardlabel">Status :
                                                  <span class="badge <?php if($userdata['status'] == 1){echo 'greenbadge';}else{ echo 'redbadge';}?>"><?php if($userdata['status'] == 1){echo 'Active';}else{ echo 'Inactive';}?></span>
                                                </p>
                                            </div>
                                ...
                                <div class="shadowcardfooter">
                                    <div style="text-align: center;">
                                        ...
                                        <a href="<?=base_url('User/user_update_form?id='.$userdata['user_id'])?>"
