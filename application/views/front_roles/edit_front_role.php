...
<!--                                <div class="col-md-9">
                ...
                <form action="<?=base_url('User/update_front_role')?>" method="post" class="edit_role" autocomplete="off"> 
                   <!-- cardheader -->
                   <input type="hidden" name="Role_id" value="<?php echo isset($roledata[0]->Role_id) ? $roledata[0]->Role_id : '' ;?>" >
...
<!--                      <p class="formheader">Basic Information</p>-->
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control customcardinput" id="fname" name="role_name" value="<?=isset($roledata[0]->role_name) ? $roledata[0]->role_name : '';?>" aria-describedby="" placeholder="Please enter Front Role Name" >
                    ...
                    <div class="container  mb25">
                      <p class="formheader">Permissions</p>
                        <?php $arr4 = isset($roledata[0]->pos_rights) ? explode(',',$roledata[0]->pos_rights) : ''; ?>
                        <ul id="myUL">
                        ...
                        <?php $arr5 = isset($roledata[0]->reports_rights) ? explode(',',$roledata[0]->reports_rights) : ''; ?>
                        <ul id="myUL">
                        ...
                        <?php $arr6 = isset($roledata[0]->inventory_rights) ? explode(',',$roledata[0]->inventory_rights) : ''; ?>
                        <ul id="myUL">
                        ...
                        <?php $arr7 = isset($roledata[0]->loyalty_rights) ? explode(',',$roledata[0]->loyalty_rights) : ''; ?>
                        <ul id="myUL">
                        ...
                        <?php $arr8 = isset($roledata[0]->store_rights) ? explode(',',$roledata[0]->store_rights) : ''; ?>
                        <ul id="myUL">
                        ...
                        <?php $arr9 = isset($roledata[0]->hrms_rights) ? explode(',',$roledata[0]->hrms_rights) : ''; ?>
                        <ul id="myUL">
                        ...
                        <?php $arr1 = isset($roledata[0]->submit_timecard_rights) ? explode(',',$roledata[0]->submit_timecard_rights) : ''; ?>
                        <ul id="myUL">
...
<!--                                <ul class="nested ml-5 active">
                        ...
                        <?php $arr3 = isset($roledata[0]->market_place_rights) ? explode(',',$roledata[0]->market_place_rights) : ''; ?>
                        <ul id="myUL">
