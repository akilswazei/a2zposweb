            ...
            <div class="customcard">
              <div >
                <div class="usercardheader">
                  ...
                  <a href="<?=base_url('User/add_front_role')?>" type="button" class="btn btn-outline-dark alluserbtn adduserbtn">Add 
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <a href="<?=base_url('User/edit_front_role?id='.$r['id'])?>" type="button" class="btn btn-outline-dark alluserbtn">Edit 
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
         <form class="delete-Role" method="post" action="<?php echo base_url('User/delete_front_role'); ?>">
