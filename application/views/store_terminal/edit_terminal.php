  ...
  <div class="row">
    <div class="col-md-12">
      <div class="customcard">
        ...
        <!-- cardheader -->        
        <form action="<?= base_url('Cterminal/update_store_terminal') ?>" method="post" id="edit-terminal" name="edit-terminal">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control customcardinput generate_license" name="merchant_id" id="merchant_id">
                                ...
                                ?>
                                    <option value="<?php print $value_m["id"]; ?>" <?php if(!empty($terminaldata['merchant_id']) && $terminaldata['merchant_id'] == $value_m["id"]) print "selected='selected'"; ?>><?php print $value_m["name"]; ?></option>
                                <?php
                                        }
                                    }
                                ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control customcardinput" id="terminal_id" name="terminal_id" aria-describedby="" placeholder="Please enter Terminal ID" onkeypress="return onlyAlphabets(event,this);" value="<?= isset($terminaldata['terminal_id']) ? $terminaldata['terminal_id'] : ''; ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control customcardinput" id="mac_address" name="mac_address" aria-describedby="" placeholder="Please enter Mac Address" onkeypress="return onlyAlphabets(event,this);" value="<?= isset($terminaldata['mac_address']) ? $terminaldata['mac_address'] : ''; ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="license_key" id="license_key" class="form-control customcardinput" aria-describedby="" placeholder="License Key" value="<?= isset($terminaldata['license_key']) ? $terminaldata['license_key'] : ''; ?>" readonly="readonly">
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="is_deleted" value="1" <?= ($terminaldata['is_deleted'] == 1) ? 'checked' : ''; ?>>
                            <label class="form-check-label customcardlabel checklabel filled-in" for="exampleCheck1">Is Deleted?</label>
                        </div>
                    </div>    
...
<script type="text/javascript">
  ...
  $('#btnSave').click(function() {
    ...
    get_store_basedon_merchant('<?php print !empty($terminaldata['merchant_id']) ? $terminaldata['merchant_id'] : 0; ?>','<?php print !empty($terminaldata['store_id']) ? $terminaldata['store_id'] : 0; ?>');
