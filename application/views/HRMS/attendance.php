                ...
                <div class="row">
                  <div class="col-md-12 mt-2 mb-3 ">
                   ...
                   <h5 class="text-center">Are you sure to delete this record ?</h5>
                      ...
                      <input type="hidden" name="deleteUserId" id="deleteUserId" class="form-control" value="">
                </div>
              </div>
            </div>
            <div class="modal-footer">
        ...
        if($('#fromdate').val() != '' && $('#todate').val() != '')
        {
         ...
         $.ajax({
                    ...
                    success: function(data){ 
                         ...
                         $("#emp_attendace_table tbody tr").remove(); 
                         $("#emp_attendace_table tbody").append(data.EmpAttHtml);
