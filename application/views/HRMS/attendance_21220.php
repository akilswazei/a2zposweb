                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="black" for="email">Name:</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="black" for="email">Date Range:</label>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>21/08/2020</td>
                                                        <td>Mr Admin</td>
                                                        <td>21/Aug/2020 12:27 - 21/Aug/2020 21:27</td>
                                                        <td>09:07:47 hours</td>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                         <div class="form-group">
                                                                             ...
                                                                             <input type="text" class="form-control " id="" aria-describedby="" placeholder="enter the value Employee Name">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                         <div class="form-group">
                                                                             ...
                                                                             <input type="date" class="form-control " id="" aria-describedby="" placeholder="enter the Start Date">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" class="form-control " id="" aria-describedby="" placeholder="enter the End Date">
