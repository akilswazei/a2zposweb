                ...
                <div>
                    ...
                    <div class="customcardbody">
                        <table class="table table-striped" id="tbl_department">
                            ...
                            <tbody>
                                <?php $i=1; if(!empty($department)){ foreach ($department as $d) {?>
                                <tr>
                                    <!-- <th scope="row"></th> -->
                                    <td><?=$i?></td>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
       <form action="<?=base_url('Hrms/insert_department')?>" method="post">
        <div class="modal-content">
            <div class="modal-header custommodalheader">
                <h5 class="modal-title custommodaltitle" id="exampleModalLongTitle">Add a department</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="customcardlabel" for="exampleFormControlSelect1 ">Department:</label>
                                <input type="text" class="form-control customcardinput inputfile" id="department" name="department" aria-describedby="emailHelp" placeholder="enter department" onkeypress="return onlyAlphabets(event,this);"/>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
         <form class="delete-Role" method="post" action="<?php echo base_url('Hrms/delete_department'); ?>">
            <div class="modal-body modalscroll">
              <div class="container">
                <div class="row">
                  <div class="col-md-12 mt-2 mb-3 ">
                   ...
                   <h5 class="text-center">Are you sure to delete this record ?</h5>
                      ...
                      <input type="hidden" name="department_id" id="delete_id" class="form-control">
                </div>
              </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
       <form action="<?=base_url('Hrms/update_department')?>" method="post">
        <div class="modal-content">
            <div class="modal-header custommodalheader">
                <h5 class="modal-title custommodaltitle" id="exampleModalLongTitle">Update department</h5>
                <input type="hidden" name="department_id" id="edit_department_id" class="form-control customcardinput">
            </div>
            <div class="modal-body modalscroll">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="customcardlabel" for="exampleFormControlSelect1 ">Department:</label>
                                <input type="text" class="form-control customcardinput inputfile2" id="editDepartment" name="department" aria-describedby="emailHelp" placeholder="enter department" onkeypress="return onlyAlphabets(event,this);"/>
...
<script>
    $('.btnADD').on('click', function() {
        if($('#department').val() == ''){
            $("#dpt_err").html("Please enter Department Name").show();
            return false;
        }
        if($('#description').val() == ''){
    ...
    $('#department').on('keypress', function() {
    ...
    $('#btnUpdate').click(function(){
        ...
        if($('#editDepartment').val() == ''){
            $("#department_err").html("Please enter Department Name").show();
            return false;
        }
    ...
    $('#editDepartment').on('keypress', function() {
        var regex = new RegExp("^[a-zA-Z,& ]+$");
        var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
        if (!regex.test(key)) {
            $("#department_err").html("Only Alphabets and Special Characters , and & are allowed").show();
            return false;
        }else{
            $("#department_err").html("").show();
    ...
    $('#tbl_department').on('click', '.editRecord', function() { 
         var department_id = $(this).data('id');
         $.ajax({
         type: 'ajax',
         method: 'post',
         url : '<?=base_url("Hrms/getDepartmentById")?>',
    ...
    $('#tbl_department').on('click', '.deleteRecord', function() {
