...
<div class="container-fluid mt20">
             <div class="row">
               <div class="col-md-12">
                     ...
                     <div class="customcard">
                         ...
                         <!-- cardheader -->
                        <form action="<?=base_url('Cproduct/insert_product')?>" method="post" class="save-lead" enctype="multipart/form-data" autocomplete="off"> 
                          <div class="">
                                   ...
                                   <div class="col-md-12"><br><br></div>
                                      ...
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           <label class="customcardlabel" for="">Lead Name*</label>
                                           <input type="text" onClick="this.select();" required="" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[name]" value="<?php echo isset($lead->name)?$lead->name:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           <label class="customcardlabel" for="">Lead Email*</label>
                                           <input type="email" onClick="this.select();" required="" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[email]" value="<?php echo isset($lead->email)?$lead->email:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           <label class="customcardlabel" for="">Lead Address*</label>
                                           <input type="text" onClick="this.select();" required="" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[address]" value="<?php echo isset($lead->address)?$lead->address:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                       ...
                                       <div class="form-group ">
                                           ...
                                           <input type="text" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[city]" value="<?php echo isset($lead->city)?$lead->city:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      ...
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="text" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[state]" value="<?php echo isset($lead->state)?$lead->state:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      ...
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="text" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[tin]" value="<?php echo isset($lead->tin)?$lead->tin:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="text" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[mobile_no]" value="<?php echo isset($lead->mobile_no)?$lead->mobile_no:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="text" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[company_name]" value="<?php echo isset($lead->company_name)?$lead->company_name:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="text" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[industry_type]" value="<?php echo isset($lead->industry_type)?$lead->industry_type:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                    ...
                                    <!--   <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="number" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[no_of_store]" value="<?php echo isset($lead->no_of_store)?$lead->no_of_store:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      ...
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                           ...
                                           <input type="number" onClick="this.select();" class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[no_of_terminal]" value="<?php echo isset($lead->no_of_terminal)?$lead->no_of_terminal:'' ?>" plceholder="Please enter Product Name">
                                          <span class="errors" id="name_err" style="color:red; font-size:14px"></span>
                                         </div>
                                      </div>
                                      ...
                                      <div class="col-md-4 ">
                                       <div class="form-group ">
                                          ...
                                          <?php if($this->uri->segment(2)=='add'){ ?>
                                            <input type="text" readonly=""  class="form-control customcardinput"  aria-describedby="" name="lead[license_key]" value="<?php  echo date('ymdhis').rand(10000,999999)  ?>" plceholder="Please enter Product Name">
                                            <?php   } else { ?>  
                                           <input type="text" disabled=""  class="form-control customcardinput" id="product_name" aria-describedby="" name="lead[license_key]" value="<?php echo isset($lead->license_key)?$lead->license_key:'' ?>" plceholder="Please enter Product Name">
                                            <?php  } ?>
 ...
 -->
                            ...
                            <div style="text-align: center;">
                                ...
                                <button type="submit" class="btn btn-primary custom_save_lead btn-sm" id="btnSave">Save</button>
                            </div>
...
$('.save-lead').submit(function(e){
    e.preventDefault();
    <?php if($this->uri->segment(2)=='add'){ ?>
    $.ajax({
                type: 'POST',
                url: '<?=base_url("superadmin/lead/save")?>',
                data: $(this).serialize(),
                dataType: "json",
    ...
    $.ajax({
                type: 'POST',
                url: '<?=base_url("superadmin/lead/update/".$this->uri->segment(4))?>',
                data: $(this).serialize(),
                dataType: "json",
                success: function(data) {
                    if(data=="success"){
