...
class Categories extends CI_Model
{
    ...
    //Category product
    public function category_product($cat_id, $per_page, $page, $price_range = null, $size = null, $brand=null, $rate=null,$sort=null)
    {
		...
		if ($all_brand) {
			//$category_ids = array_merge($all_brand,$category_ids);
